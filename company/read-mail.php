...
$sql = "SELECT * FROM mailbox WHERE id_mail='$_GET[id_mail]' AND (id_fromuser='$_SESSION[id_company]' OR id_touser='$_SESSION[id_company]')";
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Jobify</b> Portal</span>
    </a>
          ...
          <section class="content">
            <div class="row">
              <div class="col-md-12">
                ...
                $sqlReply = "SELECT * FROM reply_mailbox WHERE id_mail='$_GET[id_mail]'";
                ...
                if($resultReply->num_rows > 0) {
                  ...
                  <div class="box box-primary">
                    <div class="box-body no-padding">
                      <div class="mailbox-read-info">
                        <h3>Reply Message</h3>
                        <h5>To: <?php if($rowReply['usertype'] == "company") { echo $rowCompany['companyname']; } else { echo $rowUser['firstname']; } ?>
