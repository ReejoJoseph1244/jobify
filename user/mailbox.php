            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table id="example1" class="table table-hover table-striped">
                  ...
                  ?>
                  <tr>
                    <td class="mailbox-subject"><a href="read-mail.php?id_mail=<?php echo $row['id_mail']; ?>"><?php echo $row['subject']; ?></a></td>
                    <td class="mailbox-date">
    <?php 
    if (!empty($row['createdAt'])) {
        echo date("d-M-Y h:i a", strtotime($row['createdAt'])); 
    } else {
        echo "N/A"; // or some other default value
    }
    ?>
</td>
